...
return [
    ...
    */
    ...
    'themes_path' => base_path('resources/views'), // eg: base_path('resources/themes')
	...
	*/
	...
	'themes' => [
		...
		*/
        ...
        /*'admin-sb' => [
            'views-path' => 'admin/sb',
            'asset-path' => 'public/themes/admin-sb',
        ],*/
        'site-default' => [
            'views-path' => 'site/default',
            'asset-path' => 'public/themes/default',
        ],
	],
